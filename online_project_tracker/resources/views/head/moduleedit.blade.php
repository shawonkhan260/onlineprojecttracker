...
<div class="offset-sm-2 col-sm-8">
  ...
  @method('PATCH')
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="name" value="{{$module->name}}" name="name">
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="pwd">Details:</label>
      <textarea class="form-control" id="details" rows="5" name="details">{{$module->details}}</textarea>
    </div>
